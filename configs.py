...
class Config(object):
    API_ID = int(os.getenv("API_ID", "26467416"))
    API_HASH = os.getenv("API_HASH", "3deea0bac0302998ab8c4935cee37f9d")
    BOT_TOKEN = os.getenv("BOT_TOKEN", "5944909506:AAGZdcik3PjwrlwzzoFkyuOAADqS6f-PkhU")
...
#   Channel id where your posts are stored.
    CHANNEL_ID = int(os.getenv("CHANNEL_ID", "-1001581656370")) 
    BOT_USERNAME = os.getenv("BOT_USERNAME", "pretubebot")
    BOT_OWNER = int(os.getenv("BOT_OWNER", "5772711610"))
#   OWNER_USERNAME = os.getenv("OWNER_USERNAME", "expertdeveloperr")
    BACKUP_CHANNEL = os.getenv("BACKUP_CHANNEL", "expertbotz")
...
Just Type Movie name in pm or group 🦋**""" ) 
    START_PHOTO = os.getenv("START_PHOTO", "https://telegra.ph/file/5c586e00f34665267ab5b.jpg")
...
ꜰᴏʀ ᴍᴏʀᴇ ɪɴꜰᴏ ᴄʟɪᴄᴋ ᴏɴ ʜᴇʟᴘ ✅""" )
    ...
    DATABASE_URL = os.getenv("DATABASE_URL", "mongodb+srv://pretube:pretube@pretube.el3stoq.mongodb.net/?retryWrites=true&w=majority")
    LOG_CHANNEL = int(os.getenv("LOG_CHANNEL", "-1001721490285"))
    RESULTS_COUNT = int(os.getenv("RESULTS_COUNT", 20))
    BROADCAST_AS_COPY = os.getenv("BROADCAST_AS_COPY", "True")
    UPDATES_CHANNEL_USERNAME = os.getenv("UPDATES_CHANNEL_USERNAME", "pretubes")
    FORCE_SUB = os.getenv("FORCE_SUB", "False")
    AUTO_DELETE_TIME = int(os.getenv("AUTO_DELETE_TIME", 120))
    MDISK_API = os.getenv("MDISK_API", "a3frOmv04hmadKZENBlG")
...
ᴅᴍ ꜰᴏʀ ᴀɴʏ Qᴜᴇʀʏ  <a href='https://t.me/expertbotz'>expertbotz</a> 🤖""" )
    ABOUT_WATCH_TEXT = """
ʜᴇʏ ʙᴜᴅᴅʏ, 
...
ʀᴇɢᴀʀᴅs - <a href='https://t.me/expertbotz'>expertbotz</a>"""
    ABOUT_MDISK_TEXT = """
...
👉 <a href='https://t.me/expertbotz'>expertbotz</a>
